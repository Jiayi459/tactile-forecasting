...
| model | ActionSense | `d256 none` | `raw` | `df` | `d1` | `d1_mse` | `d1_map2` | `d1_map3` | `d1_pg` |
|---|---|---|---|---|---|---|---|---|---|
| AR | 0.200 | 0.101 | 0.148 | 0.148 | 0.367 | 0.367 | 0.367 | 0.367 | 0.367 |
| seasonal | 0.000 | −0.047 | −0.019 | −0.019 | −0.038 | −0.038 | −0.038 | −0.038 | −0.038 |
| probGRU | — | 0.002 | 0.203 | 0.207 | 0.386 | 0.383 | — | — | 0.386 |
...
| model | ActionSense | `d256 none` | `raw` | `df` | `d1` | `d1_mse` | `d1_map2` | `d1_map3` | `d1_pg` |
|---|---|---|---|---|---|---|---|---|---|
| AR | 0.254 | 0.131 | 0.214 | 0.214 | 0.431 | 0.431 | 0.431 | 0.431 | 0.431 |
| seasonal | 0.000 | −0.040 | −0.015 | −0.015 | −0.033 | −0.033 | −0.033 | −0.033 | −0.033 |
| probGRU | — | −0.057 | 0.288 | 0.278 | 0.427 | 0.431 | — | — | 0.427 |
...
| model | ActionSense | `d256 none` | `raw` | `df` | `d1` | `d1_mse` | `d1_map2` | `d1_map3` | `d1_pg` |
|---|---|---|---|---|---|---|---|---|---|
| AR | 0.194 | −0.032 | 0.171 | 0.171 | 0.476 | 0.476 | 0.476 | 0.476 | 0.476 |
| seasonal | 0.000 | −0.073 | −0.016 | −0.016 | −0.009 | −0.009 | −0.009 | −0.009 | −0.009 |
| probGRU | — | −0.218 | 0.221 | 0.227 | 0.472 | 0.472 | — | — | 0.472 |
