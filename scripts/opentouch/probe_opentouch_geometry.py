...
Usage:
    python scripts/opentouch/probe_opentouch_geometry.py --cache ~/opentouch/cache
    python scripts/opentouch/probe_opentouch_geometry.py --shard /path/to/office_csail_p2.hdf5
    python scripts/opentouch/probe_opentouch_geometry.py --cache ~/opentouch/cache --shard <f>
"""
