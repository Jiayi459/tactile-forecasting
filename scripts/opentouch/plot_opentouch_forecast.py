...
hours the forecasts themselves cost.
    ...
    python scripts/opentouch/plot_opentouch_forecast.py --preds runs/preds --n 4
    python scripts/opentouch/plot_opentouch_forecast.py --preds runs/preds --clips 812,1503 --origin 0.5
"""
