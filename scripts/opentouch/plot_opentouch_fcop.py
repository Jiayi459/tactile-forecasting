...
scripts/actionsense/plot_signal_decomposition.py does the analogous plot for ActionSense but hard-
...
mirrors the file layout but names the field `action`, hence this separate entry point.
    ...
    python scripts/opentouch/plot_opentouch_fcop.py --actions holding,sliding,"picking up" --n 3
    python scripts/opentouch/plot_opentouch_fcop.py --actions lifting --n 5 --out docs/lifting.png
"""
