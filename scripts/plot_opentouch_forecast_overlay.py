...
Deliberately mirrors scripts/plot_forecast_overlay.py, the ActionSense figure that writes
...
Reads what --save-preds wrote. No training, no GPU.
    ...
    python scripts/plot_opentouch_forecast_overlay.py --preds runs/preds --n-clips 3
    python scripts/plot_opentouch_forecast_overlay.py --preds runs/preds \
