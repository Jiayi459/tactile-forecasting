...
Usage:
    python scripts/d256/extract_d256_states.py --root ~/forcevision --out data/d256_states
    python scripts/d256/extract_d256_states.py --root ~/forcevision --out /tmp/x --limit 3 --aux
"""
